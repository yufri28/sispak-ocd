...
<table class="table table-hover table-bordered table-striped" role="button" style="color: black;">
  ...
  foreach ($aturan as $atr): 
    ...
    <tr>
        ...
        <td class="text-center"><a id="ubaha" class="btn btn-primary btn-sm" data-toggle="modal"
                data-target="#ubah_data" data-id="<?=$atr['id_cf'];?>" data-agejala="<?=$atr['agejala'];?>"
                data-apenyakit="<?= $atr['apenyakit'];?>" data-frasa="<?= $atr['frasa'];?>"><i class="fa fa-edit"></i>
                edit</a></td>
    </tr>
...
<nav>
    <ul class="pagination">
        ...
        <li class="page-item"><a class="page-link font-weight-bold" href="?hal=<?= $hal-1 ?>"><i
        ...
        <li class="page-item"><a class="page-link text-danger font-weight-bold" href="?hal=<?= $i; ?>"><?= $i;  ?></a>
        </li>
